...
| B4 | READY | unassigned | T2 | B3 | nav/route markers | Add route markers/navigation test path. A debug actor must be able to travel between locations. |
...
| WATER-07 | READY | unassigned | T2 | WATER-06 | HUD/audio/main | Presentation-only water response. |
